...
2026-05-27: D12 cleanup 페이지 폐기에 따라 list/facets, POST /notes, POST
/categories/{slug}, DELETE /items/{id} 제거. GET/PATCH 만 ItemDetails (graph)
와 향후 D10.5 wiki source 패널이 공통 사용.
"""
